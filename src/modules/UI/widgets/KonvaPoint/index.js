...
const KonvaPoint = ({
  x, y, shape, scaleMultiplier, color, bordersColor, ...konvaProps
}) => {
  let Component;
  ...
  return <Component {...konvaProps} shape={shape} color={color} fill={color} stroke={bordersColor} strokeWidth={3} opacity={0.8} x={x} y={y} draggable />;
};
